...
// New renders the form for creating a new Order.
// This function is mapped to the path GET /orders/new
func (v OrdersResource) New(c buffalo.Context) error {
	c.Set("order", &models.Order{})
...
// Edit renders a edit form for a Order. This function is
// mapped to the path GET /orders/{order_id}/edit
func (v OrdersResource) Edit(c buffalo.Context) error {
	// Get the DB connection from the context
	tx, ok := c.Value("tx").(*pop.Connection)
	if !ok {
		return fmt.Errorf("no transaction found")
